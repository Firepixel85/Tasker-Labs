...
@onready
var tabs: RGSegmentControl = $TopBar/HBoxContainer/MarginContainer/HBoxContainer/RGSegmentControl
...
@onready
var installed_view: Control = $Container/MarginContainer/ViewScroll/ViewContainer/InstalledView
