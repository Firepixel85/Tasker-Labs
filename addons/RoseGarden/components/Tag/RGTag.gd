...
func _get_color_highlight():
	match color:
		"Red":
			return RoseGarden.Colors.RED_HIGHLIGHT
		"Orange":
			return RoseGarden.Colors.ORANGE_HIGHLIGHT
		"Yellow":
			return RoseGarden.Colors.YELLOW_HIGHLIGHT
		"Green":
			return RoseGarden.Colors.GREEN_HIGHLIGHT
		"Teal":
			return RoseGarden.Colors.TEAL_HIGHLIGHT
		"Blue":
			return RoseGarden.Colors.BLUE_HIGHLIGHT
		"Pink":
			return RoseGarden.Colors.PINK_HIGHLIGHT
		"Purple":
			return RoseGarden.Colors.PURPLE_HIGHLIGHT
