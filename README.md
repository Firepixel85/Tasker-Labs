...
Tasker is in a beta state, while all features are implemented, there are no external plugins developed to take full advantage of those features. That being said the app is fully functional and has some built in developer plugins so you can test out its capabilities. I have written a guide on how to enable and use these plugins, which you can read [here](https://github.com/Firepixel85/Tasker-Labs/main/developerPluginsGuide.md)
