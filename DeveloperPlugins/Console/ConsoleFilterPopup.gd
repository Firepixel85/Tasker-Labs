extends Control
@onready
var logger_ddm: RGDropDown = $RGContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/VBoxContainer/HBoxContainer/LoggerDDM
@onready var apply: RGButton = $RGContainer/MarginContainer/VBoxContainer/HBoxContainer/Apply
@onready
var exclude_logger: RGToggle = $RGContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/VBoxContainer/HBoxContainer2/VBoxContainer/ExcludeLogger
@onready
var exclude_logger_toggle: RGToggle = $RGContainer/MarginContainer/VBoxContainer/MarginContainer/VBoxContainer/VBoxContainer/HBoxContainer2/VBoxContainer/ExcludeLogger
