...
#Events
@onready
var create_event: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/CreateEvent/CreateEvent
@onready
var remove_event: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/RemoveEvent/RemoveEvent

#Notifications
@onready
var create_notification: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/CreateNotification/CreateNotification
@onready
var notification_title: RGTextField = $MarginContainer/ScrollContainer/VBoxContainer/CreateNotification/HBoxContainer/NotificationTitle
@onready
var notification_description: RGTextField = $MarginContainer/ScrollContainer/VBoxContainer/CreateNotification/HBoxContainer/NotificationDescription
@onready
var notification_error: RGToggle = $MarginContainer/ScrollContainer/VBoxContainer/CreateNotification/HBoxContainer/VBoxContainer/NotificationError
@onready
var notification_duration_text: RGText = $MarginContainer/ScrollContainer/VBoxContainer/CreateNotification/HBoxContainer/NotificationDurationText
@onready
var notification_duration_down: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/CreateNotification/HBoxContainer/HBoxContainer/NotificationDurationDown
var notification_duration: int = 4

#Toasts
@onready
var toast_text: RGTextField = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer/ToastText
@onready
var toast_color: RGDropDown = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer/ToastColor
@onready
var create_toast: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer/CreateToast
@onready
var toast_duration_text: RGText = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer/ToastDurationText
@onready
var toast_duration_down: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer/HBoxContainer/ToastDurationDown
@onready
var toast_duration_up: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer/HBoxContainer/ToastDurationUp

#Popups
@onready
var create_na_popup: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer2/Create_NA_popup
@onready
var create_sa_popup: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer3/Create_SA_popup
@onready
var create_da_popup: RGButton = $MarginContainer/ScrollContainer/VBoxContainer/HBoxContainer4/Create_DA_popup

var toast_duration := 4
var color_dic = {
	"Red": 0, "Yellow": 1, "Orange": 2, "Green": 3, "Teal": 4, "Blue": 5, "Pink": 6, "Purple": 7
}
...
func _on_create_notification_pressed() -> void:
	...
	var response = NotificationManager.queue_notification(
		notification_title.get_text(),
		notification_description.get_text(),
		notification_error.is_toggled,
		null,
		[],
